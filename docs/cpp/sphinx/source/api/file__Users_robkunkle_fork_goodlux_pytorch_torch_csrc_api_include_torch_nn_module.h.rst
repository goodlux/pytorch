...
.. _file__Users_robkunkle_fork_goodlux_pytorch_torch_csrc_api_include_torch_nn_module.h:
...
Definition (``/Users/robkunkle/fork/goodlux/pytorch/torch/csrc/api/include/torch/nn/module.h``)
-----------------------------------------------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file__Users_robkunkle_fork_goodlux_pytorch_torch_csrc_api_include_torch_nn_module.h.rst
...
- ``torch/detail/ordered_dict.h`` (:ref:`file__Users_robkunkle_fork_goodlux_pytorch_torch_csrc_api_include_torch_detail_ordered_dict.h`)

- ``torch/nn/cursor.h`` (:ref:`file__Users_robkunkle_fork_goodlux_pytorch_torch_csrc_api_include_torch_nn_cursor.h`)
